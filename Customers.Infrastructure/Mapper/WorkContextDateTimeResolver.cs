...
{
    public class WorkContextDateTimeResolver : IMemberValueResolver<object, object, DateTime, object>, IMemberValueResolver<object, object, DateTime?, object>
    {
        private readonly IWorkContext _workContext;

        public WorkContextDateTimeResolver(IWorkContext workContext)
        {
